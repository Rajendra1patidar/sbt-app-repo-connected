...
export function RateEditPopup({ itemName, listPrice, rate, onCancel, onReset, onSave }: any) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center bg-ink/40 p-4 animate-fade-in">
      <div className="animate-sheet-up w-full sm:max-w-xs rounded-3xl bg-card p-5 shadow-xl">
